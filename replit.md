...
- August 17, 2025. Revenue Section & Emotion History Enhancement: Updated 5-Year Revenue section with blue/white menu color scheme replacing previous multi-colored design. Fixed year display format to show "1 year", "2 years" etc instead of actual calendar years. Implemented default 0 data display for years player hasn't reached yet based on current game year. Created comprehensive EmotionHistorySection with identical features to revenue section, including emotion/logic/karma tracking with monthly progression charts, blue gradient header design, and category navigation. Enhanced time engine to follow proper game time ratio: 1 real day = 24 game days, 7 game days = 1 week, 4 weeks = 1 month, 12 months = 1 year. Fixed time progression intervals and added EmotionHistory to main navigation menu. Resolved LSP errors by replacing creditScore references with karma system integration.
