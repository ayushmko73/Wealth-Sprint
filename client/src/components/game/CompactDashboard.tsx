        ...
        <div className="p-2 flex-1">
          <div className="space-y-2 h-full flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-2 flex-1">
              <div className="bg-pink-400 text-white p-6 rounded-xl border border-white border-opacity-20">
              ...
              <div className="bg-orange-400 text-white p-6 rounded-xl border border-white border-opacity-20">
                <div className="flex items-center justify-between">
                  <Zap size={16} />
                  <div className="text-right">
            ...
            {/* Row 2 - 2 columns */}
            <div className="grid grid-cols-2 gap-2 flex-1">
              <div className="bg-blue-400 text-white p-6 rounded-xl border border-white border-opacity-20">
                <div className="flex items-center justify-between">
                  <Brain size={16} />
                  <div className="text-right">
              ...
              <div className="bg-purple-400 text-white p-6 rounded-xl border border-white border-opacity-20">
                <div className="flex items-center justify-between">
                  <Scale size={16} />
                  <div className="text-right">
            ...
            {/* Row 3 - 2 columns */}
            <div className="grid grid-cols-2 gap-2 flex-1">
              <div className="bg-yellow-400 text-white p-6 rounded-xl border border-white border-opacity-20">
                <div className="flex items-center justify-between">
                  <Star size={16} />
                  <div className="text-right">
              ...
              <div className="bg-emerald-400 text-white p-6 rounded-xl border border-white border-opacity-20">
                <div className="flex items-center justify-between">
                  <Battery size={16} />
                  <div className="text-right">
